; $Id: acs_radprof.pro,v 1.48 2014/03/03 19:23:35 neill Exp $
;+
; NAME:
;   
;   sdss_radprof
...
if not int_fi.exists then begin 
 ...
 if nt le 0 then begin
	 print,pre+'1Bad image.'+ int_fi.name
	 return
 endif
 if max(int(where(finite(int)))) le 0. then begin
	 print,pre+'2Bad image.'+ int_fi.name
	 return
 endif
 sz=size(int,/dim)
...
;   print, size(mskimg)
;   print, bandflag
  if keyword_set(bandflag) and file_test(bandflag) then begin
      if keyword_set(verbose) then print,pre+'Using band-flag file: '+bandflag
...
;  skyint = 1.01*skyint     ; ehsan-edit
 ...
 ;radial profile increments (default = 0.5 arcsec)
 if not keyword_set(annuli_size) then annuli_size = 0.5
 ...
 printf,lun,'# ACS_RADPROF '+ver+': total profile'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': annular profile'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': total magnitude'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': asymptotic magnitude'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': aperture magnitude'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': ellipse parameters'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': background'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
 ...
 openw,lun,outfile,/get_lun
 printf,lun,'# ACS_RADPROF '+ver+': limiting mags'
 printf,lun,'# Date : '+systime()
 printf,lun,'# ID   : '+id
 printf,lun,'# Band : '+band
 printf,lun,'# A_Gal:'+string(A_Galactic,form='(f7.3)')+' mag'
